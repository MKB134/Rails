...
ActiveRecord::Schema.define(version: 2021_07_09_141746) do
  ...
  add_foreign_key "answers", "question_ids"
  add_foreign_key "questions", "test_ids"
  add_foreign_key "tests", "category_ids"
  add_foreign_key "tests", "user_ids"
end
